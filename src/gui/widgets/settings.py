...
class SettingsWidget(QWidget):
    ...
    def _setup_ui(self):
        ...
        self.mumu_exe_path_edit.setPlaceholderText("可填 MuMu 安装目录；留空自动查找 C/D/E/F 常见路径")
        ...
        update_group_layout.addWidget(
            self._hint_label(
                "默认使用 GitHub Releases 更新源。通过 Velopack 安装后可自动下载并应用更新；"
                "卸载请到 Windows“已安装的应用”中操作。"
            )
        )
